...
from maturacao_helper import calcular_tempo_maturacao, calcular_estabilizacao, formatar_resultado_maturacao
...
class GeradorRelatorioGxP:
    ...
    def gerar_pdf(self):
        ...
        # NOVO: Calcular maturacao se necessario
        if self.tipo_equipamento in ["freezer", "container"] and self.incluir_teste_maturacao:
            print("   Calculando tempos de maturacao...")
            for idx, estudo in enumerate(self.estudos, 1):
                if estudo['tipo'] != 'temperatura':
                    continue
                arquivo_idx = estudo['arquivo_idx']
